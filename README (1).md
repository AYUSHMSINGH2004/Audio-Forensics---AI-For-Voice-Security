...
📄 **Code:** [`Dockerfile_Cloud_Run`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/Dockerfile_Cloud_Run) · [`main.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py) · [`requirements.txt`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/requirements.txt)
...
📄 **Code:** [`Dockerfile_hf_spaces`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/Dockerfile_hf_spaces) · [`main.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py)
...
📄 **Implementation:** [`v8_1_extract.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_extract.py) (WavLM + LFCC feature fusion) · [`v8_1_train.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_train.py) (LightGBM training) · [`main.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py) (FastAPI inference + threat scoring)
...
|---|---|---|---|
| **V1** | CRNN + Mel Spectrogram | Baseline; limited generalization, noise-sensitive | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V2** | Augmented CRNN | Added noise injection, time/frequency masking | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V3** | Hybrid CRNN | Improved augmentation strategy and generalization | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V4** | Wav2Vec2 + XGBoost | Major shift to transformer embeddings + Whisper | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V5** | Production Wrapper | FastAPI, ONNX inference, static + WebSocket API | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V6** | Wav2Vec2 + LFCC + XGBoost | Added phase analysis, better artifact detection | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V7** | Siamese WavLM | WavLM encoder, pair-based similarity training | [Notebook](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) |
| **V8** | WavLM DNA + XGBoost | Clip-level cached embeddings, efficient inference | [train.py](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/v8_train.py) · [extract.py](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/v8_extract.py) |
| **V8.1** | WavLM + LFCC + LightGBM | **Final production engine — 99.84% accuracy** | [train.py](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_train.py) · [extract.py](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_extract.py) · [main.py](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py) |
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"CRNN Original Brain (Version 1)"* section
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"Model Version 2"* section
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"Training Model Version 3"* section
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"Model Version 4 Training"* section
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"Model Version 5"* section
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"Version 6 Testing"* section
...
- **Code:** [`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb) — *"Version 7 Testing"* section
...
- **Code:** [`v8_train.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/v8_train.py) · [`v8_extract.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/v8_extract.py) · [`v8_xgboost_wavlm.json`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/v8_xgboost_wavlm.json)
...
- **Code:** [`v8_1_train.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_train.py) · [`v8_1_extract.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_extract.py) · [`main.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py) (production inference API)
...
- 🧪 Training and evaluation scripts ([`Backend/`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/tree/main/Backend) · [`Data Preprocessing/`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/tree/main/Data%20Preprocessing))
- 📓 Primary research and experimentation notebooks ([`untitled.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/untitled.ipynb))
...
📄 **Code:** [`master_pipeline.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/master_pipeline.py) (end-to-end dataset construction) · [`download_all.sh`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/download_all.sh) (Mozilla Data Collective downloader)
...
📄 **Code:** [`glotlid_detector.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/glotlid_detector.py)
...
📄 **Code:** [`master_pipeline.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/master_pipeline.py) · 🧪 Engine evaluation notebook: [`Testing_Different_TTS_Engines.ipynb`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/Testing_Different_TTS_Engines.ipynb)
...
📄 **Code:** [`elevenlabs_fake_audio_generation (1).py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/elevenlabs_fake_audio_generation%20%281%29.py)
...
📄 **Code:** [`OpenAI AND Google Cloud TTS Audio Generation.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/OpenAI%20AND%20Google%20Cloud%20TTS%20Audio%20Generation.py)
...
📄 **Code:** [`convert_audio.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/convert_audio.py) (format validation & resampling) · [`extract_voices.sh`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Data%20Preprocessing/extract_voices.sh) (voice/segment extraction)
...
📄 **Code:** [`v8_1_extract.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_extract.py) → `apply_telephonic_augmentation()`
...
📄 **Implementation:** [`main.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py)
...
**File:** [`live_stream_tester_v8_1.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/live_stream_tester_v8_1.py)
...
| File | Purpose |
|---|---|
| [`AuthContext.jsx`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/contexts/AuthContext.jsx) | Initializes Firebase; wires up Authentication, Firestore, and Storage |
| [`UploadZone.jsx`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/components/UploadZone.jsx) | Drag-and-drop audio upload with format validation |
| [`ResultCard.jsx`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/components/ResultCard.jsx) | Renders the threat report returned by the backend |
| [`apiHelpers.js`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/lib/apiHelpers.js) | Builds the `/analyze` and `/ws/stream` URLs from environment variables |
| [`responseNormalizer.js`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/lib/responseNormalizer.js) | Normalizes backend JSON into a UI-friendly shape |
| [`vite.config.js`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/vite.config.js) | Build configuration for the React/Vite app |
...
Before deploying, **the user must add their own Firebase project configuration.** Open [`AuthContext.jsx`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/contexts/AuthContext.jsx) and replace every placeholder in `firebaseConfig` with the values from **Firebase Console → Project Settings → General → Your apps**:
...
The platform relies on **three** Firebase services, all initialized in [`AuthContext.jsx`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Frontend/apps/web/src/contexts/AuthContext.jsx):
...
Each analysis generates a structured forensic report, returned directly from the `/analyze` endpoint in [`main.py`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/V_8_1_Cloud_Run_Deployment/main.py):
...
**Classification Report** (from [`Evaluation Metrics.txt`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/Evaluation%20Metrics.txt)):
...
**Evaluation Plots** (from [`v8_1_evaluation_plots.png`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_evaluation_plots.png)):
...
| Evaluation Source | [`Evaluation Metrics.txt`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/Evaluation%20Metrics.txt) · [`v8_evaluation_plots.png`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_Production/v8_evaluation_plots.png) | [`Evaluation Metrics.txt`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/Evaluation%20Metrics.txt) · [`v8_1_evaluation_plots.png`](https://github.com/AYUSHMSINGH2004/Audio-Forensics---AI-For-Voice-Security/blob/main/Backend/V_8_1_Production/v8_1_evaluation_plots.png) |
